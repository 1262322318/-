...
-- DORIS sql 
-- ******************************************************************** --
-- [已合入正式脚本] 2026-05-20 厨电逻辑已合并到 dws_ipd_ipm_dxmodel_detail_dd.sql
-- ******************************************************************** --
-- 厨电事业部 - 新品规划命中率 DWS层明细（副本草稿）
-- 参照：冰冷洗 内销新品规划命中率 逻辑（zhibiao_type = '4'）
-- 说明：业务逻辑等同冰箱产品线，仅筛选范围调整为厨电
--       产品线通过HX00223字段判定
--       LX规划量通过 product_big IN ('供热采暖类产品','厨房电器类产品') 筛选
--       无ODM剔除（所有海信系产品，无剔除）
--       新品期12个月，保护期4个月（上市月为0月，第4个月开始考核）
