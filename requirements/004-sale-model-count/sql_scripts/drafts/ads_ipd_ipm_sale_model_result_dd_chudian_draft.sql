...
-- DORIS sql 
-- ******************************************************************** --
-- [已合入正式脚本] 2026-05-20 厨电逻辑已合并到 ads_ipd_ipm_sale_model_result_dd.sql
-- ******************************************************************** --
-- author: lvxuebin.ex
...
where company in ('冰冷','洗衣机','空调公司','视像科技','厨电','集团汇总')  --同时插入集团汇总计划值
...
left join weidu_product_line t3 on t1.company in  ('冰冷','空调公司','厨电')
where t1.dt_month = DATE_FORMAT('${GP_START_DT}', '%Y%m') 
and t1.company in ('冰冷','洗衣机','空调公司','视像科技','厨电')
and t1.is_project = 'N'
